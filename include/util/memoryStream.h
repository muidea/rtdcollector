...
#ifndef __MEMORY_STREAM_H_1502__
...
class Util_API MemoryIOS: public virtual std::ios
...
class Util_API MemoryInputStream: public MemoryIOS, public std::istream
...
class Util_API MemoryOutputStream: public MemoryIOS, public std::ostream
	/// An input stream for reading from a memory area.
{
public:
...
#endif // __MEMORY_STREAM_H_1502__
