...
class Util_API Mutex: private MutexImpl
...
{
public:
	typedef Util::ScopedLock<Mutex> ScopedLock;
...
class Util_API FastMutex: private FastMutexImpl
...
{
public:
	typedef Util::ScopedLock<FastMutex> ScopedLock;
...
{
public:
	typedef Util::ScopedLock<NullMutex> ScopedLock;
