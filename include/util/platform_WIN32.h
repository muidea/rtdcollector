...
#ifndef __PLATFORM_WIN32_H_1510__
#define __PLATFORM_WIN32_H_1510__


#include "unWindows.h"


#ifndef UTIL_FORCE_MIN_WINDOWS_OS_SUPPORT
	...
	#endif
#endif // UTIL_FORCE_MIN_WINDOWS_OS_SUPPORT


#if defined(_MSC_VER) && !defined(UTIL_MSVC_SECURE_WARNINGS) && !defined(_CRT_SECURE_NO_DEPRECATE)
...
// Check debug/release settings consistency
	...
	#define UTIL_MSVS_VERSION 2003
	#define UTIL_MSVC_VERSION 71
#elif (_MSC_VER >= 1400) && (_MSC_VER < 1500) // Visual Studio 2005, MSVC++ 8.0
	#define UTIL_MSVS_VERSION 2005
	#define UTIL_MSVC_VERSION 80
#elif (_MSC_VER >= 1500) && (_MSC_VER < 1600) // Visual Studio 2008, MSVC++ 9.0
	#define UTIL_MSVS_VERSION 2008
	#define UTIL_MSVC_VERSION 90
#elif (_MSC_VER >= 1600) && (_MSC_VER < 1700) // Visual Studio 2010, MSVC++ 10.0
	#define UTIL_MSVS_VERSION 2010
	#define UTIL_MSVC_VERSION 100
#elif (_MSC_VER >= 1700) && (_MSC_VER < 1800) // Visual Studio 2012, MSVC++ 11.0
	#define UTIL_MSVS_VERSION 2012
	#define UTIL_MSVC_VERSION 110
#elif (_MSC_VER >= 1800) && (_MSC_VER < 1900) // Visual Studio 2013, MSVC++ 12.0
	#define UTIL_MSVS_VERSION 2013
	#define UTIL_MSVC_VERSION 120
#elif (_MSC_VER >= 1900) && (_MSC_VER < 1910) // Visual Studio 2015, MSVC++ 14.0
	#define UTIL_MSVS_VERSION 2015
	#define UTIL_MSVC_VERSION 140
#elif (_MSC_VER >= 1910) && (_MSC_VER < 2000) // Visual Studio 2017, MSVC++ 14.1
	#define UTIL_MSVS_VERSION 2017
...
#if defined(_MSC_VER) && (_MSC_VER >= 1700) && !defined(PLATFORM_ENABLE_CPP11)
	#define UTIL_ENABLE_CPP11
#endif

#endif // __PLATFORM_WIN32_H_1510__
